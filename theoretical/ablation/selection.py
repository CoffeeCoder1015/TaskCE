...
def run_ablation_analysis(
    ...
    result_paths = {
        "good": output_dir / "ablation_selection_good.csv",
        "bad": output_dir / "ablation_selection_bad.csv",
        "iou_ranked": output_dir / "ablation_selection_iou_ranked.csv",
    }
    good_neurons.to_csv(result_paths["good"], index=False)
    bad_neurons.to_csv(result_paths["bad"], index=False)
    iou_ranked_neurons.to_csv(result_paths["iou_ranked"], index=False)
